...
parallel layout) see
[the rendered HTML on GitHub Pages](https://c-bychloe.github.io/realityai-agents/diagrams/agent_core_architecture.html)
or [the source](docs/diagrams/agent_core_architecture.html).
