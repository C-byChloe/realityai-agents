...
| ID | Version | Owner | Call site | Bench set | Audit (2026-05-07) | Last review |
|---|---|---|---|---|---|---|
| [intent_classifier](intent_classifier.md) | 1.0.0 | wenwen | `orchestrator.classify_intent` | trace_eval_set | ok | 2026-05-07 |
| [intent_analyzer](intent_analyzer.md) | 1.0.0 | wenwen | `safety.outer.intent_analyzer.analyze_intent` | outer_safety_smoke_eval | ok | 2026-05-07 |
| [coref_resolver](coref_resolver.md) | 1.0.0 | wenwen | `preprocessing.coref_resolver.make_coref_resolver_node` | coref_eval_set | ok | 2026-05-07 |
| [query_agent](query_agent.md) | 1.0.0 | wenwen | `agents.query_agent._make_route_node` | trace_eval_set | ok | 2026-05-07 |
| [action_agent](action_agent.md) | 1.0.0 | wenwen | `agents.action_agent._make_route_node` | inner_safety_smoke_eval | ok | 2026-05-07 |
| [planning_agent](planning_agent.md) | 1.0.0 | wenwen | `agents.planning_agent.make_plan` | trace_eval_set | warn (accepted) | 2026-05-07 |
